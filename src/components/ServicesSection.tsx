...
const services = [
  {
    icon: Zap,
    title: "Electrical",
    items: ["Fault finding & diagnostics", "Light fittings & installations", "Plug points & wiring", "General electrical maintenance"],
  },
  {
    icon: Droplets,
    title: "Plumbing",
    items: ["Leak detection & repairs", "Pipe replacement", "Fixture installations", "General plumbing maintenance"],
  },
  {
    icon: Waves,
    title: "Water Systems",
    items: ["Borehole systems", "Filtration systems", "Pressure systems", "Reverse osmosis"],
  },
  {
    icon: Home,
    title: "Property Maintenance",
    items: ["Painting", "Ceiling repairs", "Drywalling", "General repairs & restoration"],
  },
  {
    icon: ShieldCheck,
    title: "Security & Automation",
    items: ["Gate motors", "Access control", "Biometric systems", "Basic automation"],
  },
];
